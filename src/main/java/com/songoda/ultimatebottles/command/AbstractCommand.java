...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(UltimateBottles instance, CommandSender sender, String... args);

    protected abstract List<String> onTab(UltimateBottles instance, CommandSender sender, String... args);
